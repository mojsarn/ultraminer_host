...
namespace CS_FPGA_CLIENT
{
    ...
    public class StandardStratum : Stratum
    {
        ...
        public new class Job : Stratum.Job
        {
            ...
            private StandardStratum mStratum;
            ...
            public new StandardStratum Stratum { get { return mStratum; } }
        ...
        protected override void ProcessLine(String line)
        {
            ...
            if (response.ContainsKey("method") && response.ContainsKey("params"))
            {
                ...
                if (method.Equals("mining.set_difficulty"))
                {
                    ...
                    UInt64 target = (UInt64)((double)0xffff0000UL / (mDifficulty / 256));
                    Program.Logger("target : " + String.Format("0x{0:X16}", target));
                }
        ...
        public StandardStratum(String aServerAddress, int aServerPort, String aUsername, String aPassword, String aPoolName, String aAlgorithm)
            : base(aServerAddress, aServerPort, aUsername, aPassword, aPoolName, aAlgorithm)
        {
        }
    }
}
